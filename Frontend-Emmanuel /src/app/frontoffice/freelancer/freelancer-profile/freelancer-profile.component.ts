  ...
  loadProfile(): void {
    ...
    this.profileService.getMyProfile().subscribe({
      ...
      error: (error) => {
        ...
        if (error.status === 404) {
          // No profile found - new freelancer
          console.log('No professional profile found, creation needed');
          this.snackBar.open('Please create your professional profile', 'Close', {
            duration: 5000
          });
        } else {
