...
export class RecommendationService {
   ...
   */
  getRecommendationsByClientId(clientId: number, status?: RecommendationStatus): Observable<Recommendation[]> {
    if (status) {
   ...
   */
  getRecommendationsByFreelanceId(freelanceId: number): Observable<Recommendation[]> {
   ...
   */
  getPendingRecommendationsForFreelance(freelanceId: number): Observable<Recommendation[]> {
